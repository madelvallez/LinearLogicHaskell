...
pcom1::Proof   --Left Parr Comm / Redex Ax
...
pcom1'::Proof   --Right Comm Parr / Redex Ax
...
pcom2 :: Proof         -- Comm L Bot / Redex Ax
...
pcom3::Proof       --CommR Tensor L /then Redex Un
...
pcom3'::Proof       --CommL Tensor R /then Redex Un
...
pcom3''::Proof         --Comm R Tensor L /then Redex Un
...
pcom3'''::Proof        --Comm R Tensor R /puis redex Un
...
pcom4::Proof       --Comm L With / redex Ax
...
pcomplus::Proof        --Comm LBot/ (Comm R Parr /puis redex Ten)
...
pred1 = CutRule (With (WhyNot a) (WhyNot b)) [c, Not c] (Plus (OfCourse (Not a)) (OfCourse (Not b))) [WhyNot a]
            pcom4
            (PlusRRule (OfCourse (Not a)) (OfCourse (Not b)) [WhyNot a]
...
pred5 = CutRule (WhyNot (Not a)) [OfCourse c, WhyNot (Not c)] (OfCourse a) [Plus (WhyNot (Not a)) b]
            (PromRule c [WhyNot (Not a), WhyNot (Not c)]
                (AffRule (Not a) [c, WhyNot (Not c)]
                    (DerRule (Not c) [c]
                        (AxRule c (Not c)))))
            (PlusRRule (WhyNot (Not a)) b [OfCourse a]
                (PromRule a [WhyNot (Not a)]
                    (DerRule (Not a) [a]
                        (AxRule a (Not a)))))
